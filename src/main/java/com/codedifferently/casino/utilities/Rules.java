...
public class Rules {
   ...
   //private String GameName;
    ...
    //public static String learnGoFish(String GameName) {
        static String goFishRules = "Minimum of 2 players" + "1. The first thing you do is deal cards to the players.\n"
        ...
        static String blackJackRules = "**The goal of blackjack is to beat the dealer's hand without going over 21.**\n"
            ...
            static String crapsRules = "1. Each round in craps starts with what is known as the come-out roll. It is required that the\n"
            ...
            static String sevenFreeSlotsRules = "**Objective is to get all 3 matching symbols**\n"
            +"Bet 1 or the max(3)\n"+"Spin reels";

            static String rouletteRules = "After all the participants in the game have placed their bets on the table,\n"
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter Desired Game\n" +
        "1.Go Fish \n 2.Black Jack \n 3.Craps \n 4.Seven Free Slots \n 5.Roulette");
        ...
        if (GameName.equals("Go Fish")) {
            System.out.print(goFishRules);
        }
        if (GameName.equals("Black Jack")) {
            System.out.print(blackJackRules);
        }
        if(GameName.equals("Craps"))
        {
            System.out.print(crapsRules);
        }
        if(GameName.equals("Seven Free Slots"))
        {
            System.out.print(sevenFreeSlotsRules);
        }
        if(GameName.equals("Roulette"))
        {
            System.out.print(rouletteRules);
        }
        else
        {
