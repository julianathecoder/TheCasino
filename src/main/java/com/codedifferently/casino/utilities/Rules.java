...
public class Rules {
    ...
    private String goFishRules = goFishRules();
    private String blackJackRules = blackJackRules();
    private String crapsRules = crapsRules();
    private String sevenFreeSlotsRules = sevenFreeSlotsRules();
    private String rorouletteRules = rouletteRules();

    public Rules(String goFishRules, String blackJackRules, String crapsRules, String sevenFreeSlotsRules, String rouletteRules)
    {
        this.goFishRules = goFishRules;
        this.blackJackRules = blackJackRules;
        this.crapsRules = crapsRules;
        this.sevenFreeSlotsRules = sevenFreeSlotsRules;
        this.rorouletteRules = rouletteRules;
    }

    public String getGoFishRules()
    {
        return this.goFishRules;
    }
    private String goFishRules() 
    {
    ...
    public String getBlackJackRules()
    {
        return this.blackJackRules;
    }
    private String blackJackRules()
    {
    ...
    public String getCrapsRules()
    {
        return this.crapsRules;
    }
    private String crapsRules()
    {
    ...
    public String getSevenFreeSlotsRules()
    {
        return this.sevenFreeSlotsRules;
    }
    private String sevenFreeSlotsRules()
    {
        return "**Objective is to get all 3 matching symbols**\n"
        +"Bet 1 or the max(3)\n"+"Spin reels";
    }

    public String getRouletteRules()
    {
        return this.rorouletteRules;
    }
    public String rouletteRules()
    {
